require = function() {
  ...
  Login: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      onLogin: function onLogin(wx_user, key) {
        var self = this;
  ...
  MainScene: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      onLoad: function onLoad() {
        ...
        if (null == g_music_key || g_music_key == BOOL.YES || "" == g_music_key) {
  ...
  pj_game_room: [ function(require, module, exports) {
    ...
    cc.Class({
      ...
      start: function start() {
        ...
        g_music_key = cc.sys.localStorage.getItem(MUSIC_KEY);
        if (null == g_music_key || g_music_key == BOOL.YES || 0 == g_music_key.length) {
          cc.audioEngine.stopAll();
          this.current = cc.audioEngine.play(this.audio, true, 1);
        }
        this.pomelo_on();
    ...
    cc.Class({
      ...
      onLoad: function onLoad() {
        ...
        cc.game.on(cc.game.EVENT_SHOW, function() {
          ...
          if (1007 == self.options["scene"] && null != self.options["query"]["room_num"]) {
      ...
      enter_scene: function enter_scene(room_num, rid) {
        var param = {
          room_num: room_num,
          rid: rid,
          player_id: g_user["id"]
      ...
      onKeyDown: function onKeyDown(event) {
        switch (event.keyCode) {
         case cc.KEY.back:
          util.show_isok_info(function(flag) {
            true == flag ? cc.director.end() : cc.log("press back continue");
          }, "确定要退出游戏吗?");
        }
      }
    });
