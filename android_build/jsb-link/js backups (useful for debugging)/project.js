...
var n = 0 | g(e, i), o = (t = a(t, n)).write(e, i);
o !== n && (t = t.slice(0, o));
return t;
}(t, e, i) : function(t, e) {
if (_.isBuffer(e)) {
...
n || (n = "utf8");
for (var s, r, a, c, l, h, _, u, g, p = !1; ;) switch (n) {
case "hex":
return m(this, t, e, i);

case "utf8":
case "utf-8":
return u = e, g = i, F(B(t, (_ = this).length - u), _, u, g);
...
var s, r, a = 8 * o - n - 1, c = (1 << a) - 1, l = c >> 1, h = -7, _ = i ? o - 1 : 0, u = i ? -1 : 1, g = t[e + _];
_ += u;
s = g & (1 << -h) - 1;
g >>= -h;
h += a;
...
if (0 === s) s = 1 - l; else {
if (s === c) return r ? NaN : Infinity * (g ? -1 : 1);
r += Math.pow(2, n);
s -= l;
}
return (g ? -1 : 1) * r * Math.pow(2, s - n);
};
i.write = function(t, e, i, n, o, s) {
var r, a, c, l = 8 * s - o - 1, h = (1 << l) - 1, _ = h >> 1, u = 23 === o ? Math.pow(2, -24) - Math.pow(2, -77) : 0, g = n ? 0 : s - 1, p = n ? 1 : -1, d = e < 0 || 0 === e && 1 / e < 0 ? 1 : 0;
e = Math.abs(e);
...
for (;8 <= o; t[i + g] = 255 & a, g += p, a /= 256, o -= 8) ;
r = r << o | a;
l += o;
for (;0 < l; t[i + g] = 255 & r, g += p, r /= 256, l -= 8) ;
t[i + g - p] |= 128 * d;
};
}, {} ],
...
this.login_flag = !1;
if (cc.sys.os == cc.sys.OS_ANDROID) {
var t = jsb.reflection.callStaticMethod("org.cocos2dx.javascript.AppActivity", "getAppId", "()Ljava/lang/String;"), e = jsb.reflection.callStaticMethod("org.cocos2dx.javascript.AppActivity", "getAppSecret", "()Ljava/lang/String;"), i = jsb.reflection.callStaticMethod("org.cocos2dx.javascript.AppActivity", "getWXCode", "()Ljava/lang/String;");
this.debug_label.string = "appid:" + t + " app_secret:" + e + " wx_code:" + i;
if (null != i && "null" != i) {
Storage.setData("app_id", t);
Storage.setData("app_secret", e);
this.callback = this.get_access_token;
this.debug_label.string = "wx_code:" + i;
...
i = jsb.reflection.callStaticMethod("NativeOcClass", "getWXCode");
this.debug_label.string = "appid:" + t + " app_secret:" + e + " wx_code:" + i;
if (null != i && "null" != i) {
Storage.setData("app_id", t);
Storage.setData("app_secret", e);
...
this.debug_label.string = "access_token:" + JSON.stringify(t);
...
if (null != t.openid) {
this.debug_label.string = "get_wxuser_info:" + JSON.stringify(t);
...
this.debug_label.string = "onInitLogin:" + t;
if (null == t) {
if (cc.sys.os == cc.sys.OS_ANDROID) {
...
200 == t.code ? i.saveUserInfo(t.player) : i.debug_label.string = t.msg;
});
} else i.debug_label.string = t.msg;
});
},
...
var _ = !1, u = a[h], g = u.getComponent("pj_card");
cc.log("card_item_com id:" + g.id + " selected_cards:" + r.selected_cards.length);
for (var p = 0; p < i.length; p++) if (g.id == i[p]) {
_ = !0;
break;
}
...
l[p].getComponent("pj_card").id = p;
}
for (p = 0; p < c.length; p++) {
c[p].getComponent("pj_card").id = p + 2;
}
this.set_cards_w(s, l);
this.set_cards_h(s, c);
} else {
for (p = 0; p < l.length; p++) {
l[p].getComponent("pj_card").id = p + 2;
}
for (p = 0; p < c.length; p++) {
c[p].getComponent("pj_card").id = p;
}
...
var l = this, h = e.width / 2, _ = e.height / 2, u = cc.instantiate(g_assets.pop_game_finish), g = u.getComponent("pop_game_finish");
this.node.addChild(u);
g.init_info(s, function() {
l.onExit();
});
...
var h = cc.moveTo(.5, i.getPosition()), _ = cc.rotateBy(.5, 360), u = cc.spawn(h, _), g = cc.callFunc(function() {
c.getComponent("bomb_action").play(l);
});
c.runAction(cc.sequence(u, g));
},
...
e.pomelo = l;
var i = null, n = 0, o = {}, s = {}, h = {}, _ = 0, u = 0, g = 0, p = null, d = null, f = null, m = {
sys: {
type: "js-websocket",
version: "0.0.1"
},
...
switch (t) {
case "uInt32":
return c.decodeUInt32(g());

case "int32":
case "sInt32":
return c.decodeSInt32(g());
...
case "string":
var o = c.decodeUInt32(g()), s = c.decodeStr(a, l, o);
l += o;
return s;
...
function u(t, e, i) {
if (s.isSimpleType(e)) for (var n = c.decodeUInt32(g()), o = 0; o < n; o++) t.push(_(e)); else t.push(_(e, i));
}
function g(t) {
var e, i = [], n = l;
t = t || !1;
...
for (var e = new p(3 * t.length), i = 0, n = 0; n < t.length; n++) {
...
for (var e = new p(t), i = [], n = 0, o = 0, s = e.length; n < s; ) {
if (e[n] < 128) {
o = e[n];
n += 1;
} else if (e[n] < 224) {
...
i.encode = function(t, e) {
var i = e ? e.length : 0, n = new p(4 + i), o = 0;
n[o++] = 255 & t;
n[o++] = i >> 16 & 255;
n[o++] = i >> 8 & 255;
n[o++] = 255 & i;
...
i.decode = function(t) {
for (var e = 0, i = new p(t), n = 0, o = []; e < i.length; ) {
var s = i[e++], r = (n = (i[e++] << 16 | i[e++] << 8 | i[e++]) >>> 0) ? new p(n) : null;
f(r, 0, i, e, n);
e += n;
o.push({
type: s,
...
o.decode = function(t) {
var e = new p(t), i = e.length || e.byteLength, n = 0, o = 0, s = null, r = e[n++], a = 1 & r, c = r >> 1 & 7;
if (m(c)) {
