(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/login/Register.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'ddc3f+ssUBG6qFL1qdnuKXW', 'Register', __filename);
...
cc.Class({
	...
	input_phone_begin: function input_phone_begin() {
		this.ptip_label.string = "";
	},
	input_phone_end: function input_phone_end() {
		var self = this;
	...
	input_name_begin: function input_name_begin() {
		this.nick_label.string = "";
	},
	input_name_end: function input_name_end() {
		this.nick_name = this.name_box.getComponent(cc.EditBox).string;
	},
	input_qianming_begin: function input_qianming_begin() {},
	input_qianming_end: function input_qianming_end() {
		this.sign_text = this.qianming_box.getComponent(cc.EditBox).string;
	},
	input_pwd_begin: function input_pwd_begin() {
		this.pwd_label.string = "";
	},
	input_pwd_end: function input_pwd_end() {
		this.password = this.pwd_box.getComponent(cc.EditBox).string;
	},
	input_rpwd_begin: function input_rpwd_begin() {
		this.rtip_label.string = "";
	},
	input_rpwd_end: function input_rpwd_end() {
