(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/game_room/tdk_game_room.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '4d823h/YH5BN70QBcwWdVtD', 'tdk_game_room', __filename);
// Script/game_room/tdk_game_room.js
...
cc.Class({
	...
	init_head_info: function init_head_info() {
		...
		var position = this.node.convertToNodeSpaceAR(cc.p(size.width / 2, size.height + g_dealCardBack.getContentSize().height / 2));
	...
	initButtonEnableAfterThrow: function initButtonEnableAfterThrow() {
		this.bipai_button.getComponent(cc.Button).interactable = false;
		this.kaipai_button.getComponent(cc.Button).interactable = false;
		this.qipai_button.getComponent(cc.Button).interactable = false;
		this.genzhu_button.getComponent(cc.Button).interactable = false;
	...
	initButtonEnableAfterFapai: function initButtonEnableAfterFapai() {
	...
	initButtonEnableAfterFapaiNext: function initButtonEnableAfterFapaiNext() {
		if (g_myselfPlayerPos == this.currentGetPowerPlayerPosition) {
			this.genzhu_button.getComponent(cc.Button).interactable = true;
			this.jiazhu_button.getComponent(cc.Button).interactable = true;
	...
	initButtonEnableAfterFapaiContinue: function initButtonEnableAfterFapaiContinue() {
		this.genzhu_button.getComponent(cc.Button).interactable = false;
		this.jiazhu_button.getComponent(cc.Button).interactable = false;
		if (g_myselfPlayerPos == this.currentGetPowerPlayerPosition) {
			this.genzhu_button.getComponent(cc.Button).interactable = true;
	...
	initPlayerCardsPosition: function initPlayerCardsPosition() {
	...
	callback_genzhu: function callback_genzhu() {
		this.genzhu_button.getComponent(cc.Button).interactable = false;
		if (this.fapai_count >= 5) {
			pomelo.request(util.getGameRoute(), {
				process: "follow",
	...
	callback_qipai: function callback_qipai() {
		this.qipai_button.getComponent(cc.Button).interactable = false;
		pomelo.request(util.getGameRoute(), {
			process: "throw",
			location: g_myselfPlayerPos
	...
	callback_bipai: function callback_bipai() {
	...
	callback_jiazhu: function callback_jiazhu() {
		var self = this;
	...
	onAdd_function: function onAdd_function(data) {
  ...
  */
	...
	onFapaiNext_function: function onFapaiNext_function(data) {
	...
	onFapaiContinue_function: function onFapaiContinue_function(data) {
	...
	onThrow_function: function onThrow_function(data) {
	...
	onFollow_function: function onFollow_function(data) {
	...
	onAddChip_function: function onAddChip_function(data) {
	...
	onLeave_function: function onLeave_function(data) {
	...
	onChangePlayer_function: function onChangePlayer_function(data) {
	...
	onBipai_function: function onBipai_function(data) {
	...
	onEqual_function: function onEqual_function(data) {
	...
	onEqualPai_function: function onEqualPai_function(data) {
	...
	onEndPai_function: function onEndPai_function(data) {
	...
	onNoRound_function: function onNoRound_function(data) {
	...
	actionSendGift: function actionSendGift(pnode, type, send_from, send_to) {
	...
	actionFaPai: function actionFaPai() {
		var size = cc.director.getVisibleSize();
		var isFind = false;
		...
		if (this.startDealCardPosition1 == this.startDealCardPosition) {
			this.fapai_count++;
		}
	...
	actionFaPaiNext: function actionFaPaiNext(mythis, mycard) {
		var size = cc.director.getVisibleSize();
	...
	actionFaPaiContinue: function actionFaPaiContinue(mythis, mycard) {
		var size = cc.director.getVisibleSize();
	...
	actionFaPaiEqual: function actionFaPaiEqual(mythis, winners) {
		var size = cc.director.getVisibleSize();
		var isFind = false;
		var playerArrayPosition = -1;
	...
	actionBottomBet: function actionBottomBet(player_position) {
		var size = cc.director.getVisibleSize();
		var countNumber = -1;
	...
	actionFollowBet: function actionFollowBet(player_position, isCheckCard) {
	...
	setPlayerCardsPosition: function setPlayerCardsPosition(player, card_len) {
		var player_com = player.getComponent("tdk_player");
	...
	actionWinnerGetBet: function actionWinnerGetBet(my_this, playerPosition) {
	...
	biPaiSelectCallBack: function biPaiSelectCallBack(index) {
		pomelo.request(util.getGameRoute(), {
			process: "bipai",
...
cc._RF.pop();
        ...
        //# sourceMappingURL=tdk_game_room.js.map
