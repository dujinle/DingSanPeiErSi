(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/game_room/zhq_game_room.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, 'bbeeaBGTdFPQ6Rw9pY9lS1m', 'zhq_game_room', __filename);
// Script/game_room/zhq_game_room.js
...
cc.Class({
	...
	initButtonEnableAfterDealCards: function initButtonEnableAfterDealCards() {
	...
	initButtonEnableChuPai: function initButtonEnableChuPai() {
		this.start_button.getComponent(cc.Button).interactable = false;
		this.zhunbei_button.getComponent(cc.Button).interactable = false;
		this.touxiang_button.getComponent(cc.Button).interactable = false;
		this.liangA_button.getComponent(cc.Button).interactable = false;
	...
	callback_jiefeng: function callback_jiefeng() {
		this.jiefeng_button.getComponent(cc.Button).interactable = false;
		pomelo.request(util.getGameRoute(), {
			process: "jiefeng",
			location: g_myselfPlayerPos
	...
	callback_touxiang: function callback_touxiang() {
		pomelo.request(util.getGameRoute(), {
			process: "throw",
			flag: true,
			location: g_myselfPlayerPos
	...
	callback_butouxiang: function callback_butouxiang() {
		pomelo.request(util.getGameRoute(), {
			process: "throw",
			flag: false,
			location: g_myselfPlayerPos
	...
	callback_chupai: function callback_chupai() {
	...
	callback_buchupai: function callback_buchupai() {
		this.chupai_button.getComponent(cc.Button).interactable = false;
		this.buchupai_button.getComponent(cc.Button).interactable = false;
		pomelo.request(util.getGameRoute(), {
			process: "pass",
	...
	callback_liangA: function callback_liangA() {
		var playerPosition = -1;
		for (var i = 0; i < g_players.length; i++) {
			var player = g_players[i];
			var player_com = player.getComponent("zhq_player");
	...
	onStart_function: function onStart_function(data) {
  ...
  */
	...
	onShoupaiFirst_function: function onShoupaiFirst_function(data) {
	...
	onPass_function: function onPass_function(data) {
	...
	onJieFeng_function: function onJieFeng_function(data) {
	...
	onChuPai_function: function onChuPai_function(data) {
	...
	onChuPaiTip_function: function onChuPaiTip_function(data) {
	...
	onMarkA_function: function onMarkA_function(data) {
	...
	onFinish_function: function onFinish_function(data) {
	...
	onStartChuPai_function: function onStartChuPai_function(data) {
	...
	actionFaPai: function actionFaPai() {
		...
		player_com.set_card_sprite(card_len, parseInt(this.myselfCards[card_len][0]), parseInt(this.myselfCards[card_len][1]));
		card.setPosition(position);
	...
	actionBottomBet: function actionBottomBet(loserPlayerPosition, winPlayerPosition) {
		var size = cc.director.getWinSize();
		var countNumber = -1;
...
cc._RF.pop();
        ...
        //# sourceMappingURL=zhq_game_room.js.map
