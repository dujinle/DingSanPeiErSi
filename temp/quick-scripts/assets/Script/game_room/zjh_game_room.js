(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/Script/game_room/zjh_game_room.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '0b0efI2PelH177LdiR8rfH7', 'zjh_game_room', __filename);
// Script/game_room/zjh_game_room.js
...
cc.Class({
  ...
  */
			...
			if (player_com.position_server == playerPositionServer) {
				...
				if (this.comparableState == true) {
					if (this.bipai_ui.isValid == true) {
						...
						var callBackWinnerGetBet = cc.callFunc(this.actionWinnerGetBet, this, player.getPosition());
	...
	actionBiPai: function actionBiPai(playerPositionServer1, playerPositionServer2, loserPositionServer) {
	...
	openAllCard: function openAllCard(mythis, winnerCardType) {
		//打开自己的牌
		var tmp_allplayers = g_players_noPower.concat(g_players);
		for (var i = 0; i < tmp_allplayers.length; i++) {
			var player = tmp_allplayers[i];
	...
	setPlayerCardsBackPosition: function setPlayerCardsBackPosition(player, card_len) {
		var player_com = player.getComponent("zjh_player");
		for (var m = 0; m < card_len; m++) {
			var position = this.calc_player_card_position(player, m);
			var card = player_com.my_cards[m].getComponent("zjh_card");
	...
	startFirstRotationPosition: function startFirstRotationPosition() {
	...
	displayLoser: function displayLoser(mythis, loserPositionServer) {
		var tmp_allplayers = g_players_noPower.concat(g_players);
		for (var i = 0; i < g_players.length; i++) {
			var player_com = g_players[i].getComponent("zjh_player");
	...
	setRoomStateCompare: function setRoomStateCompare() {
		this.comparableState = false;
	},
...
cc._RF.pop();
        ...
        //# sourceMappingURL=zjh_game_room.js.map
